...
compiled as part of the Linear Buddy open source project (the "Extension")
to the extent the Software is a required component of the Extension;
...
Linear Buddy Team, and Linear Buddy Enterprise). Subject to the foregoing
sentence, you are free to modify this Software and publish patches to the
Software. You agree that Licensor and/or its licensors (as applicable) retain
all right, title and interest in and to all such modifications and/or patches,
and all such modifications and/or patches may only be used, copied, modified,
displayed, distributed, or otherwise exploited with a valid subscription for
the correct number of user seats for the Software. In furtherance of the
foregoing, you hereby assign to Licensor all such modifications and/or patches.
You are not granted any other rights beyond what is expressly stated herein.
Except as set forth above, it is forbidden to copy, merge, publish, distribute,
sublicense, and/or sell the Software.

The full text of this Linear Buddy Pro License shall be included in all copies
