...
- **Chat** with an AI assistant about your work
- **Convert TODOs** to tickets instantly (Linear)
- **Generate standups** from your commits and activity
- **Switch platforms** seamlessly via settings

## Supported Platforms

✅ **Linear** - Full feature set with AI workflows  
✅ **Jira Cloud** - Core features with workflow transitions  
⏳ **More coming soon** - Monday.com, ClickUp, and others
