...
exports.shouldUseRealApi = shouldUseRealApi;
exports.TestConfig = {
 ...
 */
function getMockServerUrl(platform) {
    const { host } = exports.TestConfig.mockServer;
    const port = platform === "linear"
        ? exports.TestConfig.mockServer.linearPort
        : exports.TestConfig.mockServer.jiraPort;
...
function shouldUseRealApi() {
    return exports.TestConfig.env.useRealApi;
}
